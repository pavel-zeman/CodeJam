// Decrease the number one by one until the second half of digits equals 00...01. Then reverse, decrease one by one until getting 10...01. Then decrease by 2 and continue from the beginning.
